...
Router.prototype.resource = function(route, resource) {
    ...
    if (resource.create) this.post(route, function(req, res) { multipart(req, res, function(req, res) {
    ...
    if (resource.update) this.post(route + '/:id', function(req, res) { multipart(req, res, function(req, res) {
